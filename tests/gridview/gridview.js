(function ($) {
  ...
  test("setOptions 'frozenColumn' from frozen to unfrozen", function () {
    ...
    currentWidth = $paneHeaderL.outerWidth() + $paneHeaderR.outerWidth();
    equal(currentWidth, width);

    currentWidth = $paneTopL.outerWidth() + $paneTopR.outerWidth();
    equal(currentWidth, width);

    currentWidth = $viewportTopL.outerWidth() + $viewportTopR.outerWidth();
    equal(currentWidth, width);
  });
